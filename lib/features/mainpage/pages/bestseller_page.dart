...
import '../controllers/bestseller_controller.dart';
...
class BestsellerPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(BestsellerController());

    return Scaffold(
      backgroundColor: Colors.white,
      appBar: AppBar(
        title: const Text('베스트셀러', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
        backgroundColor: Colors.white,
        elevation: 0,
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(image: NetworkImage(book['imageUrl']), fit: BoxFit.cover),
                    ),
                  ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('${book['author']} | 평균 ★ ${book['rating']}', style: const TextStyle(fontSize: 12, color: Colors.grey)),
                      ],
                    ),
                  )
                ],
