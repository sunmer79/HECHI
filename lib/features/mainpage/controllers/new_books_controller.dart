...
class NewBooksController extends GetxController {
  ...
  // 파싱 함수 (위와 동일 - 복사해서 사용하세요)
  Map<String, dynamic> _parseBookItem(dynamic item) { /* ... 위 코드 참조 ... */
    // BestsellerController의 _parseBookItem과 동일합니다.
